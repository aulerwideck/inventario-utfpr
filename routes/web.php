...
Route::middleware(['auth'])->group(['prefix' => 'inventory'], function () {
    Route::get('/new',
        'InventoryController@create')->name('inventory.create')->middleware('permission:create inventories');
    Route::get('/{inventory}',
        'InventoryController@show')->name('inventory.show')->middleware('permission:read inventories');
    Route::get('/{inventory}/edit',
        'InventoryController@edit')->name('inventory.edit')->middleware('permission:update inventories');
    Route::get('/{inventory}/destroy',
        'InventoryController@destroy')->name('inventory.destroy')->middleware('permission:delete inventories');
    Route::get('/{inventory}/relatories',
        'InventoryController@relatories')->name('inventory.relatories')->middleware('permission:see relatories');
    Route::group(['prefix' => '{inventory}/relatory'], function () {
        ...
        Route::get('/localizacao',
            'InventoryController@relatoryLocalizacao')->name('inventory.relatory.localizacao');
        ...
        Route::get('/semPatrimonio',
            'InventoryController@relatorySemPatrimonio')->name('inventory.relatory.semPatrimonio');
        ...
        Route::get('/listLocalizacao',
            'InventoryController@listLocalizacao')->name('inventory.relatory.listLocalizacao');
        Route::get('/listObservacao',
            'InventoryController@listObservacao')->name('inventory.relatory.listObservacao');
        Route::get('/listProep', 'InventoryController@listProep')->name('inventory.relatory.listProep');
        Route::get('/listSemPatrimonio',
            'InventoryController@listSemPatrimonio')->name('inventory.relatory.listSemPatrimonio');
...
Route::middleware(['auth'])->group(['prefix' => 'collect'], function () {
...
Route::middleware(['auth'])->group(['prefix' => 'local'], function () {

    Route::get('/new/{inventory}',
        'LocalController@create')->name('local.create')->middleware('permission:create locals');
    ...
    Route::get('/{local}/destroy',
        'LocalController@destroy')->name('local.destroy')->middleware('permission:remove locals');
    Route::get('/{local}/collect',
        'LocalController@collect')->name('local.collect')->middleware('permission:collect locals');
    Route::get('/{id_local}/listPatrimonies', 'LocalController@listPatrimonies')->name('local.listPatrimonies');
    Route::get('/{id_local}/listPatrimoniesCollecteds',
        'LocalController@listPatrimoniesCollecteds')->name('local.listPatrimoniesCollecteds');
